...
const AccountList = ({ accounts, onDisconnect }: AccountListProps) => {
    ...
    if(accounts.length === 0) {
            ...
            <div className="bg-white rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center py-20 px-6">
                ...
                bg-slate-50 rounded-2xl flex items-center
                ...
                <p className="text-sm text-slate-400 mt-1 max-w-xs text-center">Connect your first social platform to start scheduling and automating your content.
                </p>
            </div>
            )
    }
  ...
  return (
    <div
      key={index}
      className="group bg-white border rounded-2xl p-5 flex items-center gap-4 border-slate-200 hover:border-slate-300 transition-all"
    >
